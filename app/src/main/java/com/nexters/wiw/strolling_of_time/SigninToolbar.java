...
public class SigninToolbar extends Toolbar {
    ...
    public SigninToolbar(Context context) {
        this(context,null);
    }

    public SigninToolbar(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SigninToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
